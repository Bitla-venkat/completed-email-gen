"""
Django settings for email_generator project.
...
SECRET_KEY = 'django-insecure-f7&33uipl-^_g#j$)9w4*eig7#h3^(+#)b#yenf2%_+ex#ow_3'
...
EMAIL_HOST = "smtp.gmail.com"  # Use Gmail SMTP or your email provider
